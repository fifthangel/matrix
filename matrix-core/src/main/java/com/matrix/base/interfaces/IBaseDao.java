 ...
 * @version 1.0.1
 */
public interface IBaseDao<PK extends Serializable , E extends BaseEntity , D extends BaseDto, V extends BaseView> {
...
//    public <DTO> void deleteByCondition(DTO dto); 
     ...
     * @version 1.0.0.1
     */
    public List<V> pageListByDto(D dto);
     ...
     * @version 1.0.0.1
     */
//    public <DTO> List<E> findGroupList(DTO dto);                                     方法废弃
